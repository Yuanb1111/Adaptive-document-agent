"""Optional user-selected artwork for local presentation export.

Artwork is an illustration, never analytical evidence. It is not added to the
...
def add_picture_profile(presentation, company, title: str, pages: list[int], artwork: bytes):
    ...
    _picture(slide, artwork, Rect(.83 + text_width, top, width - text_width - 1.38, height - 1.5 - top))
